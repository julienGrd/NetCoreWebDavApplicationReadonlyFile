...
using NetCoreWebDavApplication2.Configuration;
...
namespace NetCoreWebDavApplication2
{
    ...
    public class DavEngineCore : DavEngineAsync
    {
        ...
        public DavEngineCore(IOptions<DavEngineConfig> config, ILogger logger, IWebHostEnvironment env) : base()
        {
            ...
            //MyCustomPutHandler handlerPut = new MyCustomPutHandler(env.ContentRootPath);
            //MyCustomPutHandler handlerLock = new MyCustomPutHandler(env.ContentRootPath);
            //MyCustomPutHandler handlerUnlock = new MyCustomPutHandler(env.ContentRootPath);
            //handlerPut.OriginalHandler = RegisterMethodHandler("PUT", handlerPut);
            //handlerLock.OriginalHandler = RegisterMethodHandler("LOCK", handlerLock);
            //handlerUnlock.OriginalHandler = RegisterMethodHandler("UNLOCK", handlerUnlock);
